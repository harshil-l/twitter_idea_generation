    ...
    <div className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
      <div className="px-4 py-6 sm:px-0">
        <div className="mb-8">
          ...
          <p className="mt-2 text-gray-600">Welcome to your home maintenance hub</p>
        </div>
          ...
          <div className="bg-white overflow-hidden shadow rounded-lg">
            <div className="p-5">
              <div className="flex items-center">
                ...
                <div className="ml-5 w-0 flex-1">
                  <dl>
                    <dt className="text-sm font-medium text-gray-500 truncate">Appliances</dt>
          ...
          <div className="px-4 py-5 sm:p-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <div className="text-sm font-medium text-gray-900">HVAC filter replacement completed</div>
              ...
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <div className="text-sm font-medium text-gray-900">Water heater maintenance due</div>
              ...
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <div className="text-sm font-medium text-gray-900">New dishwasher added</div>
